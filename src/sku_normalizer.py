...
def calibrar_fatores_phantom(
    ...
    Phantoms com < `min_obs` leituras frescas recebem fator=1.0 (baseline neutro).
    """
...
def normalizar_media_phantom(
    ...
    """Adiciona ``Media_norm`` ao dataframe de força — versão auto-calibrada por phantom.

    Se ``catalog`` for fornecido, usa-o diretamente.
